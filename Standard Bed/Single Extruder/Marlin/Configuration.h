...
#define STRING_CONFIG_H_AUTHOR "Zviper89, Migbot Stndrdauto lvl" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,100}  // default steps per unit for ultimaker //78.7402, 78.7402,1070,865.88
